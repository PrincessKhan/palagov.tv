require = (function e(t, n, r) {
...
})(
    {
            ...
            function (e, t, n) {
                ...
                n.HttpMediaManager = class extends i.STEEmitter {
                    ...
                    download(e, t) {
                        ...
                        if ((r.open("GET", n, !0), (r.responseType = "arraybuffer"), e.range)) r.setRequestHeader("Range", e.range), (t = void 0);
                        ...
                        this.setupXhrEvents(r, e, t), this.settings.xhrSetup && this.settings.xhrSetup(r, n), this.xhrRequests.set(e.id, { xhr: r, segment: e }), r.send();
                    }
                    abort(e) {
                    ...
                    async segmentDownloadFinished(e, t, n) {
                        if (((e.responseUrl = null === n.responseURL ? void 0 : n.responseURL), this.settings.segmentValidator))
                            try {
        ...
        4: [
            function (e, t, n) {
                ...
                const r = e("debug"),
                    ...
                    u = e("./media-peer"),
                    c = e("./bandwidth-approximator"),
                    h = e("./segments-memory-storage"),
                    l = e("get-browser-rtc"),
                    d = {
                        ...
                        trackerAnnounce: ["wss://tracker.openwebtorrent.com", "wss://tracker.btorrent.xyz", "wss://tracker.files.fm:7073/announce", "ws://tracker.files.fm:7072/announce"],
                ...
                n.HybridLoader = class extends s.EventEmitter {
                    constructor(e = {}) {
                        super(),
                            (this.debug = r("p2pml:hybrid-loader")),
                            (this.debugSegments = r("p2pml:hybrid-loader-segments")),
                            (this.segmentsQueue = []),
                            (this.bandwidthApproximator = new c.BandwidthApproximator()),
                            ...
                            (this.downloadRandomSegmentOverHttp = async () => {
                                if (
                                    ...
                                    void 0 === this.httpRandomDownloadInterval ||
                                    this.httpDownloadInitialTimeoutTimestamp !== -1 / 0 ||
                                    this.httpManager.getActiveDownloadsCount() >= this.settings.simultaneousHttpDownloads ||
                                    (this.settings.httpDownloadProbabilitySkipIfNoPeers && 0 === this.p2pManager.getPeers().size) ||
                                    this.settings.consumeOnly
                                )
                                    return;
                                const e = await this.segmentsStorage.getSegmentsMap(this.masterSwarmId),
                                    t = this.p2pManager.getOvrallSegmentsMap(),
                                    n = this.segmentsQueue.filter(
                                        (n) => !this.p2pManager.isDownloading(n) && !this.httpManager.isDownloading(n) && !t.has(n.id) && !this.httpManager.isFailed(n) && n.priority <= this.settings.httpDownloadMaxPriority && !e.has(n.id)
                                    );
                            ...
                            (this.onSegmentLoaded = async (e, t, n) => {
                                ...
                                (e.data = t),
                                    ...
                                    this.emit(i.Events.SegmentLoaded, e, n),
                                    (r = void 0 === r ? await this.segmentsStorage.getSegmentsMap(this.masterSwarmId) : r),
                            ...
                            (this.onTrackerUpdate = async (e) => {
                                if (
                                    ...
                                    void 0 !== e.incomplete &&
                                    e.incomplete <= 1 &&
                                    (this.debugSegments("cancel initial HTTP download timeout - no peers"), (this.httpDownloadInitialTimeoutTimestamp = -1 / 0), void 0 !== this.masterSwarmId)
                                ) {
                                    const e = await this.segmentsStorage.getSegmentsMap(this.masterSwarmId);
                                    this.processSegmentsQueue(e) && !this.settings.consumeOnly && this.p2pManager.sendSegmentsMapToAll(this.createSegmentsMap(e));
                                }
                            }),
                            (this.settings = Object.assign(Object.assign({}, d), e)),
                            e.bufferedSegmentsCount &&
                                (void 0 === e.p2pDownloadMaxPriority && (this.settings.p2pDownloadMaxPriority = e.bufferedSegmentsCount),
                                void 0 === e.httpDownloadMaxPriority && (this.settings.p2pDownloadMaxPriority = e.bufferedSegmentsCount),
                                delete this.settings.bufferedSegmentsCount),
                            (this.segmentsStorage = void 0 === this.settings.segmentsStorage ? new h.SegmentsMemoryStorage(this.settings) : this.settings.segmentsStorage),
                    ...
                    async load(e, t) {
                        ...
                        for (const t of this.segmentsQueue)
                            e.find((e) => e.url == t.url) || (this.debug("remove segment", t.url), this.httpManager.isDownloading(t) ? ((n = !0), this.httpManager.abort(t)) : this.p2pManager.abort(t), this.emit(i.Events.SegmentAbort, t));
                        ...
                        (n = this.processSegmentsQueue(r) || n),
                            (await this.cleanSegmentsStorage()) && ((r = await this.segmentsStorage.getSegmentsMap(this.masterSwarmId)), (n = !0)),
                    ...
                    async destroy() {
                        void 0 !== this.httpRandomDownloadInterval && (clearInterval(this.httpRandomDownloadInterval), (this.httpRandomDownloadInterval = void 0)),
                            (this.httpDownloadInitialTimeoutTimestamp = -1 / 0),
                            (this.segmentsQueue = []),
                    ...
                    processSegmentsQueue(e) {
                        ...
                        if (this.httpDownloadInitialTimeoutTimestamp !== -1 / 0) {
                            ...
                            (r = n >= this.settings.httpDownloadInitialTimeout || (void 0 !== t && n > this.settings.httpDownloadInitialTimeoutPerSegment && t <= 0)) &&
                                (this.debugSegments("cancel initial HTTP download timeout - timed out"), (this.httpDownloadInitialTimeoutTimestamp = -1 / 0));
                        }
                                ...
                                if (!this.p2pManager.isDownloading(s))
                                    if (s.priority <= this.settings.requiredSegmentsPriority) {
                                        ...
                                        this.p2pManager.getActiveDownloadsCount() < this.settings.simultaneousP2PDownloads &&
                                            s.priority <= this.settings.p2pDownloadMaxPriority &&
                                            this.p2pManager.download(s) &&
                                            this.debugSegments("P2P download", s.priority, s.url);
                            }
                        }
                        return n;
                    }
            ...
            function (e, t, n) {
                ...
                n.MediaPeer = class extends i.STEEmitter {
                    ...
                    requestSegment(e) {
                        ...
                        this.sendCommand({ c: o.SegmentRequest, i: e }), (this.downloadingSegmentId = e), this.runResponseTimeoutTimer();
                    }
                    cancelSegmentRequest() {
                        let e;
                        if (this.downloadingSegmentId) {
                            const t = this.downloadingSegmentId;
                            (e = this.downloadingSegment ? this.downloadingSegment.pieces : void 0), this.terminateSegmentRequest(), this.sendCommand({ c: o.CancelSegmentRequest, i: t });
                        }
                        return e;
                    }
        ...
        7: [
                ...
                n.P2PMediaManager = class extends s.STEEmitter {
                    constructor(e, t) {
                        super(),
                            ...
                            (this.debug = r("p2pml:p2p-media-manager")),
                    ...
                    async setStreamSwarmId(e, t) {
                        ...
                        const n = this.pendingTrackerClient,
                            r = new u().update(h + this.streamSwarmId).digest();
                    ...
                    destroy(e = !1) {
                        (this.streamSwarmId = null),
                            this.trackerClient &&
                                ...
                                e
                                    ? (this.trackerClient.removeAllListeners("error"), this.trackerClient.removeAllListeners("warning"), this.trackerClient.removeAllListeners("update"), this.trackerClient.removeAllListeners("peer"))
                                    : (this.trackerClient.destroy(), (this.trackerClient = null))),
                            this.pendingTrackerClient && ((this.pendingTrackerClient.isDestroyed = !0), (this.pendingTrackerClient = null)),
            ...
            { "./index": "p2p-media-loader-core", "./media-peer": 6, "./stringly-typed-event-emitter": 9, "bittorrent-tracker/client": 11, buffer: 16, debug: "debug", "sha.js/sha1": 43 },
        ],
        8: [
            function (e, t, n) {
                "use strict";
                ...
                (n.byteLength = function (e) {
                    ...
                    (n.toByteArray = function (e) {
                        var t,
                            ...
                            l = a > 0 ? o - 4 : o;
                        for (n = 0; n < l; n += 4)
                            (t = (i[e.charCodeAt(n)] << 18) | (i[e.charCodeAt(n + 1)] << 12) | (i[e.charCodeAt(n + 2)] << 6) | i[e.charCodeAt(n + 3)]), (u[h++] = (t >> 16) & 255), (u[h++] = (t >> 8) & 255), (u[h++] = 255 & t);
                ...
                (function (n, r) {
                    ...
                    class p extends s {
                        constructor(e = {}) {
                            ...
                            this._trackers = t
                                .map((e) => {
                                    ...
                                    const r = t.protocol;
                                    return ("http:" !== r && "https:" !== r) || "function" != typeof l
                                        ? "udp:" === r && "function" == typeof d
                                            ? new d(this, e)
                                            : ("ws:" !== r && "wss:" !== r) || !s
                                            ? (o(new Error(`Unsupported tracker protocol: ${e}`)), null)
                                            : "ws:" === r && "undefined" != typeof window && "https:" === window.location.protocol
                                            ? (o(new Error(`Unsupported tracker protocol: ${e}`)), null)
                                            : new f(this, e)
                                        : new l(this, e);
                                })
                        ...
                        _defaultAnnounceOpts(e = {}) {
                            return (
                                null == e.numwant && (e.numwant = h.DEFAULT_ANNOUNCE_PEERS),
                    ...
                    (p.scrape = (e, t) => {
                        ...
                        if (!e.announce) throw new Error("Option `announce` is required");
                        const n = Object.assign({}, e, { infoHash: Array.isArray(e.infoHash) ? e.infoHash[0] : e.infoHash, peerId: r.from("01234567890123456789"), port: 6881 }),
                            i = new p(n);
            ...
            function (e, t, n) {
                ...
                class p extends u {
                    ...
                    announce(e) {
                        ...
                        const t = Object.assign({}, e, { action: "announce", info_hash: this.client._infoHashBinary, peer_id: this.client._peerIdBinary });
                    ...
                    destroy(e = g) {
                        ...
                        if (
                            ...
                            c[this.announceUrl].consumers > 0)
                        )
                            return e();
                    ...
                    _openSocket() {
                        (this.destroyed = !1),
                            ...
                            this.socket
                                ? ((c[this.announceUrl].consumers += 1), this.socket.connected && this._onSocketConnectBound())
                                : ((this.socket = c[this.announceUrl] = new o(this.announceUrl)), (this.socket.consumers = 1), this.socket.once("connect", this._onSocketConnectBound)),
                    ...
                    _onAnnounceResponse(e) {
                        ...
                        if (
                            (e.offer &&
                                ...
                                ((o = this._createPeer()).id = a.binaryToHex(e.peer_id)),
                                o.once("signal", (t) => {
                                    const n = { action: "announce", info_hash: this.client._infoHashBinary, peer_id: this.client._peerIdBinary, to_peer_id: e.peer_id, answer: t, offer_id: e.offer_id };
                            ...
                            (o = this.peers[t])
                                ? ((o.id = a.binaryToHex(e.peer_id)), o.signal(e.answer), this.client.emit("peer", o), clearTimeout(o.trackerTimeout), (o.trackerTimeout = null), delete this.peers[t])
                                : r(`got unexpected answer: ${JSON.stringify(e.answer)}`);
                        }
                    }
                    _onScrapeResponse(e) {
                        e = e.files || {};
            ...
            function (e, t, n) {
                (function (t) {
                    ...
                    (n.kMaxLength = o),
                        ...
                        "undefined" != typeof Symbol && null != Symbol.species && t[Symbol.species] === t && Object.defineProperty(t, Symbol.species, { value: null, configurable: !0, enumerable: !1, writable: !1 }),
                        (t.poolSize = 8192),
                        ...
                        (t.compare = function (e, n) {
                            if ((q(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)), q(n, Uint8Array) && (n = t.from(n, n.offset, n.byteLength)), !t.isBuffer(e) || !t.isBuffer(n)))
                        ...
                        (t.prototype.compare = function (e, n, r, i, s) {
                            ...
                            if ((void 0 === n && (n = 0), void 0 === r && (r = e ? e.length : 0), void 0 === i && (i = 0), void 0 === s && (s = this.length), n < 0 || r > e.length || i < 0 || s > this.length))
                                throw new RangeError("out of range index");
                            if (i >= s && n >= r) return 0;
                            if (i >= s) return -1;
                            if (n >= r) return 1;
                            if (this === e) return 0;
                            for (var o = (s >>>= 0) - (i >>>= 0), a = (r >>>= 0) - (n >>>= 0), u = Math.min(o, a), c = this.slice(i, s), h = e.slice(n, r), l = 0; l < u; ++l)
                                if (c[l] !== h[l]) {
                                    (o = c[l]), (a = h[l]);
                                    break;
                                }
                    ...
                    (t.prototype.slice = function (e, n) {
                        ...
                        (t.prototype.writeInt32BE = function (e, t, n) {
                            return (
                                (e = +e), (t >>>= 0), n || x(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), (this[t] = e >>> 24), (this[t + 1] = e >>> 16), (this[t + 2] = e >>> 8), (this[t + 3] = 255 & e), t + 4
                            );
                        }),
                            ...
                            t = Math.abs(t),
                                isNaN(t) || t === 1 / 0
                                    ...
                                    : ((o = Math.floor(Math.log(t) / Math.LN2)),
                                      ...
                                      (t += o + l >= 1 ? d / u : d * Math.pow(2, 1 - l)) * u >= 2 && (o++, (u /= 2)),
                                      o + l >= h ? ((a = 0), (o = h)) : o + l >= 1 ? ((a = (t * u - 1) * Math.pow(2, i)), (o += l)) : ((a = t * Math.pow(2, l - 1) * Math.pow(2, i)), (o = 0)));
                            i >= 8;
                ...
                (function (n, r) {
                    ...
                    a && a.getRandomValues
                        ? (t.exports = function (e, t) {
                              ...
                              if (e > 0)
                                  if (e > i) for (var u = 0; u < e; u += i) a.getRandomValues(r.slice(u, u + i));
                ...
                i(
                    ...
                    i(
                        ...
                        function (e, t, n) {
                            var r, i, o, a;
                            if (
                                ("string" == typeof t && ((i = "not "), t.substr(!o || o < 0 ? 0 : +o, i.length) === i) ? ((r = "must not be"), (t = t.replace(/^not /, ""))) : (r = "must be"),
                                (function (e, t, n) {
                ...
                (function (n) {
                    ...
                    function c(e) {
                        ...
                        i.call(this, e),
                            ...
                            e && (!1 === e.readable && (this.readable = !1), !1 === e.writable && (this.writable = !1), !1 === e.allowHalfOpen && ((this.allowHalfOpen = !1), this.once("end", h)));
                    }
                    function h() {
        ...
        29: [
            function (e, t, n) {
                (function (n, r) {
                    ...
                    var l,
                        d,
                        f = e("./internal/streams/buffer_list"),
                    ...
                    function E(t, n, r) {
                        (i = i || e("./_stream_duplex")),
                            ...
                            (this.decoder = null),
                            (this.encoding = null),
                            t.encoding && (l || (l = e("string_decoder/").StringDecoder), (this.decoder = new l(t.encoding)), (this.encoding = t.encoding));
                    }
                    function C(t) {
                    ...
                    (C.prototype.read = function (e) {
                        ...
                        if ((0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended)))
                            return c("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? U(this) : M(this), null;
                        ...
                        return (
                            ...
                            t.ended || t.reading
                                ...
                                : i && (c("do read"), (t.reading = !0), (t.sync = !0), 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), (t.sync = !1), t.reading || (e = A(n, t))),
                            null === (r = e > 0 ? N(e, t) : null) ? ((t.needReadable = !0), (e = 0)) : ((t.length -= e), (t.awaitDrain = 0)),
                            0 === t.length && (t.ended || (t.needReadable = !0), n !== e && t.ended && U(this)),
                            ...
                            return (
                                "data" === e
                                    ...
                                    : "readable" === e &&
                                      (i.endEmitted ||
                                          i.readableListening ||
                                          ((i.readableListening = i.needReadable = !0), (i.flowing = !1), (i.emittedReadable = !1), c("on readable", i.length, i.reading), i.length ? M(this) : i.reading || n.nextTick(L, this))),
                                r
                            );
                        }),
        ...
        31: [
            function (e, t, n) {
                (function (n, r) {
                    ...
                    function C(t) {
                        ...
                        (this._writableState = new E(t, this, n)),
                            (this.writable = !0),
                            t &&
            ...
            { "../errors": 25, "./_stream_duplex": 27, "./internal/streams/destroy": 34, "./internal/streams/state": 37, "./internal/streams/stream": 38, _process: 23, buffer: 16, inherits: 20, "util-deprecate": 48 },
        ],
        32: [
            function (e, t, n) {
                (function (n) {
                ...
                t.exports = (function () {
                    ...
                    return (
                        ...
                        (t.consume = function (e, t) {
                            var n;
                            return (
                                e < this.head.data.length ? ((n = this.head.data.slice(0, e)), (this.head.data = this.head.data.slice(e))) : (n = e === this.head.data.length ? this.shift() : t ? this._getString(e) : this._getBuffer(e)), n
                            );
                        }),
                        (t.first = function () {
                ...
                (function (e) {
                    ...
                    t.exports = {
                        destroy: function (t, s) {
                            ...
                            return a || u
                                ? (s ? s(t) : !t || (this._writableState && this._writableState.errorEmitted) || e.nextTick(i, this, t), this)
                ...
                t.exports = function e(t, n, s) {
                    ...
                    return (
                        !(function (e) {
                            ...
                            : (t.on("complete", h), t.on("abort", p), t.req ? g() : t.on("request", g)),
                        t.on("end", d),
                        t.on("finish", h),
                    ...
                    var d = n.map(function (t, i) {
                        ...
                        return (function (t, n, i, s) {
                            ...
                            t.on("close", function () {
                                ...
                                r(t, { readable: n, writable: i }, function (e) {
                                    if (e) return s(e);
                                    (a = !0), s();
                                });
                            var u = !1;
        ...
        41: [
            function (e, t, n) {
                ...
                i.from && i.alloc && i.allocUnsafe && i.allocUnsafeSlow ? (t.exports = r) : (s(r, n), (n.Buffer = o)),
                ...
                (function (n) {
                    ...
                    function c(e) {
                        ...
                        if (
                            ...
                            a.Duplex.call(t, e),
                            (t.channelName = e.initiator ? e.channelName || o(20).toString("hex") : null),
                            (t.initiator = e.initiator || !1),
                            (t.channelConfig = e.channelConfig || c.channelConfig),
                            (t.config = Object.assign({}, c.config, e.config)),
                            ...
                            (t.allowHalfTrickle = void 0 !== e.allowHalfTrickle && e.allowHalfTrickle),
                            (t.iceCompleteTimeout = e.iceCompleteTimeout || u),
                            (t.destroyed = !1),
                            (t._connected = !1),
                            ...
                            throw "undefined" == typeof window ? l("No WebRTC support: Specify `opts.wrtc` option in this environment", "ERR_WEBRTC_SUPPORT") : l("No WebRTC support: Not a supported browser", "ERR_WEBRTC_SUPPORT");
                        (t._pcReady = !1),
                            (t._channelReady = !1),
                            (t._iceComplete = !1),
                    ...
                    s(c, a.Duplex),
                        (c.WEBRTC_SUPPORT = !!i()),
                        (c.config = { iceServers: [{ urls: "stun:stun.l.google.com:19302" }, { urls: "stun:global.stun.twilio.com:3478" }], sdpSemantics: "unified-plan" }),
                        (c.channelConfig = {}),
                        Object.defineProperty(c.prototype, "bufferSize", {
                            get: function () {
                        ...
                        (c.prototype.signal = function (e) {
                            ...
                            t._debug("signal()"),
                                e.renegotiate && t.initiator && (t._debug("got request to renegotiate"), t._needsNegotiation()),
                                e.transceiverRequest && t.initiator && (t._debug("got request for transceiver"), t.addTransceiver(e.transceiverRequest.kind, e.transceiverRequest.init)),
                                e.candidate && (t._pc.localDescription && t._pc.localDescription.type && t._pc.remoteDescription && t._pc.remoteDescription.type ? t._addIceCandidate(e.candidate) : t._pendingCandidates.push(e.candidate)),
                                e.sdp &&
                                    t._pc
                        ...
                        (c.prototype.addTrack = function (e, t) {
                            ...
                            r
                                ? r.removed
                                    ? this.destroy(l("Track has been removed. You should enable/disable tracks that you want to re-add.", "ERR_SENDER_REMOVED"))
                                    : this.destroy(l("Track has already been added to that stream.", "ERR_SENDER_ALREADY_ADDED"))
                        ...
                        (c.prototype.replaceTrack = function (e, t, n) {
                            ...
                            var r = this._senderMap.get(e),
                                i = r ? r.get(n) : null;
                            i || this.destroy(l("Cannot replace track that was never added.", "ERR_TRACK_NOT_ADDED")),
                                t && this._senderMap.set(t, r),
                                null != i.replaceTrack ? i.replaceTrack(t) : this.destroy(l("replaceTrack is not supported in this browser", "ERR_UNSUPPORTED_REPLACETRACK"));
                        }),
                        ...
                        (c.prototype.negotiate = function () {
                            ...
                            e.initiator
                                ? e._isNegotiating
                                    ? ((e._queuedNegotiation = !0), e._debug("already negotiating, queueing"))
                                    : (e._debug("start negotiation"),
                                      setTimeout(() => {
                                          e._createOffer();
                                      }, 0))
                                : e._isNegotiating || (e._debug("requesting negotiation from initiator"), e.emit("signal", { renegotiate: !0 })),
                                (e._isNegotiating = !0);
                        }),
                            ...
                            e.destroyed ||
                                e._pc
                                    ...
                                    .then(function (t) {
                                        ...
                                        e.destroyed ||
                                            (e.trickle || e.allowHalfTrickle || (t.sdp = h(t.sdp)),
                        ...
                        (c.prototype._onIceStateChange = function () {
                            if (!this.destroyed) {
                                ...
                                this._debug("iceStateChange (connection: %s) (gathering: %s)", e, t),
                                    ...
                                    "failed" === e && this.destroy(l("Ice connection failed.", "ERR_ICE_CONNECTION_FAILURE")),
                                    "closed" === e && this.destroy(l("Ice connection closed.", "ERR_ICE_CONNECTION_CLOSED"));
                            }
                        }),
                                            ...
                                            e.getStats(function (n, r) {
                                                if (!e.destroyed) {
                                                    ...
                                                    if (
                                                        ...
                                                        r.forEach(function (e) {
                                                            "transport" === e.type && e.selectedCandidatePairId && c(o[e.selectedCandidatePairId]),
                                                                (("googCandidatePair" === e.type && "true" === e.googActiveConnection) || (("candidatepair" === e.type || "candidate-pair" === e.type) && e.selected)) && c(e);
                                                        }),
                                                ...
                                                function c(t) {
                                                    ...
                                                    n && (n.ip || n.address)
                                                        ? ((e.localAddress = n.ip || n.address), (e.localPort = Number(n.port)))
                                                        : n && n.ipAddress
                                                        ? ((e.localAddress = n.ipAddress), (e.localPort = Number(n.portNumber)))
                                                        : "string" == typeof t.googLocalAddress && ((n = t.googLocalAddress.split(":")), (e.localAddress = n[0]), (e.localPort = Number(n[1]))),
                                                        e.localAddress && (e.localFamily = e.localAddress.includes(":") ? "IPv6" : "IPv4");
                                                    var r = i[t.remoteCandidateId];
                                                    r && (r.ip || r.address)
                                                        ? ((e.remoteAddress = r.ip || r.address), (e.remotePort = Number(r.port)))
                                                        : r && r.ipAddress
                                                        ? ((e.remoteAddress = r.ipAddress), (e.remotePort = Number(r.portNumber)))
                                                        : "string" == typeof t.googRemoteAddress && ((r = t.googRemoteAddress.split(":")), (e.remoteAddress = r[0]), (e.remotePort = Number(r[1]))),
                                                        e.remoteAddress && (e.remoteFamily = e.remoteAddress.includes(":") ? "IPv6" : "IPv4"),
                        ...
                        (c.prototype._onSignalingStateChange = function () {
                            ...
                            e.destroyed ||
                                ("stable" !== e._pc.signalingState ||
                                    ...
                                    e._queuedNegotiation && (e._debug("flushing negotiation queue"), (e._queuedNegotiation = !1), e._needsNegotiation()),
                                    e._debug("negotiate"),
                                    e.emit("negotiate")),
                                (e._firstStable = !1),
                        ...
                        (c.prototype._onIceCandidate = function (e) {
                            this.destroyed ||
                                (e.candidate && this.trickle
                                    ? this.emit("signal", { candidate: { candidate: e.candidate.candidate, sdpMLineIndex: e.candidate.sdpMLineIndex, sdpMid: e.candidate.sdpMid } })
                ...
                (function (n, r) {
                    ...
                    class h extends o.Duplex {
                        constructor(e = {}) {
                            ...
                            if (((this._id = s(4).toString("hex").slice(0, 7)), this._debug("new websocket: %o", e), (this.connected = !1), (this.destroyed = !1), (this._chunk = null), (this._cb = null), (this._interval = null), e.socket))
                                (this.url = e.socket.url), (this._ws = e.socket), (this.connected = e.socket.readyState === u.OPEN);
                            else {
                                this.url = e.url;
                                try {
        ...
        events: [
            function (e, t, n) {
                ...
                function l(e, t, n) {
                    if (t) e.call(n);
                    else for (var r = e.length, i = v(e, r), s = 0; s < r; ++s) i[s].call(n);
                }
                function d(e, t, n, r) {
                    if (t) e.call(n, r);
                    else for (var i = e.length, s = v(e, i), o = 0; o < i; ++o) s[o].call(n, r);
                }
                function f(e, t, n, r, i) {
                    if (t) e.call(n, r, i);
                    else for (var s = e.length, o = v(e, s), a = 0; a < s; ++a) o[a].call(n, r, i);
                }
                function p(e, t, n, r, i, s) {
                    if (t) e.call(n, r, i, s);
                    else for (var o = e.length, a = v(e, o), u = 0; u < o; ++u) a[u].call(n, r, i, s);
                }
                function g(e, t, n, r) {
                    if (t) e.apply(n, r);
                    else for (var i = e.length, s = v(e, i), o = 0; o < i; ++o) s[o].apply(n, r);
                }
                function m(e, t, n, i) {
                    var s, o, a;
